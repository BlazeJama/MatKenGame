...
export default function LandingScreen({
  ...
  return (
    ...
    <div className="font-tac flex flex-col" style={{ maxWidth: 390, margin: "0 auto", minHeight: "100vh" }}>
      ...
      {/* Header */}
      <header style={{ background: "#070b14", paddingTop: "calc(env(safe-area-inset-top, 0px) + 26px)", paddingBottom: 26, paddingLeft: 67, paddingRight: 67, display: "flex", flexDirection: "column", alignItems: "center", gap: 12, overflow: "hidden" }}>
        ...
        <p style={{ fontFamily: "'Rajdhani', sans-serif", fontWeight: 500, fontSize: "0.6875rem", letterSpacing: "0.16em", color: "#47576b", margin: 0 }}>
